  ...
  {    
   ...
   if(isset($_POST['seacrhdata']))
   {
     ...
     $selectUser = mysqli_query($connect, "SELECT * FROM `booking` co 
        ...
        `sitter` vc ON co.bookingsSitterid = vc.sitterID  co.bookingsSitterid='".$_REQUEST['sittterid']."' AND ".$cond."
        ...
        WHERE co.bookingsSitterid='".$_REQUEST['sittterid']."'
    ORDER BY co.bookingID DESC");
   }
                ...
                <div class="card">
                 <div class="card-header">
                      ...
                      <div class="header-top">
                          <h5 class="pull-left"><?php echo $page.'List for'.$rowRole['sitterFirstname'];?> </h5>
